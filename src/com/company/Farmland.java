...
public class Farmland {
    ...
    public static int buyFarmland(int cash){
        ...
        if (getAlreadyOpenShopFarmland() == true) {
            ...
            System.out.println("1. Place Size: "+placeSize1 +" Place for animals: " + placeForAnimals1 +" Place for seeds: "+placeForSeeds1+" Place for buildings: "+placeForBuildings1+" PRICE: "+ place1Price);
            System.out.println("2. Place Size: "+placeSize2 +" Place for animals: " + placeForAnimals2 +" Place for seeds: "+placeForSeeds2+" Place for buildings: "+placeForBuildings2+" PRICE: "+ place2Price);
            System.out.println("3. Place Size: "+placeSize3 +" Place for animals: " + placeForAnimals3 +" Place for seeds: "+placeForSeeds3+" Place for buildings: "+placeForBuildings3+" PRICE: "+ place3Price);
            System.out.println("4. Place Size: "+placeSize4 +" Place for animals: " + placeForAnimals4 +" Place for seeds: "+placeForSeeds4+" Place for buildings: "+placeForBuildings4+" PRICE: "+ place4Price);
            System.out.println("5. Place Size: "+placeSize5 +" Place for animals: " + placeForAnimals5 +" Place for seeds: "+placeForSeeds5+" Place for buildings: "+placeForBuildings5+" PRICE: "+ place5Price);
            System.out.println("6. Place Size: "+placeSize6 +" Place for animals: " + placeForAnimals6 +" Place for seeds: "+placeForSeeds6+" Place for buildings: "+placeForBuildings6+" PRICE: "+ place6Price);
